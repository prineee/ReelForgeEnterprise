...
import type { PlanId, PricingPlan } from "@/types/pricing";
import { PLAN_BY_KEY } from "@/lib/plans";

/**
 * Price, credits, and billing terms come from lib/plans.ts (the source of
 * truth every payment provider charges against) — only marketing-specific
 * copy (taglines, feature bullets, discount framing) is maintained here.
 */
export const PRICING_PLANS: PricingPlan[] = [
  {
    id: "starter",
    name: PLAN_BY_KEY.starter.name,
    tagline: PLAN_BY_KEY.starter.tagline,
    price: `$${PLAN_BY_KEY.starter.priceUSD}`,
    billing: PLAN_BY_KEY.starter.billing,
    billingNote: "One-time payment · lifetime access",
    aiCredits: `${PLAN_BY_KEY.starter.credits} AI credits`,
    exportQuality: "1080p HD",
    commercialUsage: "Personal use",
    priority: "Standard",
    support: "Email support",
    limits: [`${PLAN_BY_KEY.starter.credits} AI credits`, "Up to 1080p exports", "1 user seat"],
    features: ["All AI studios", "Caption burner", "Thumbnail maker"],
    purchaseUrl: "/register?plan=starter",
  },
  {
    id: "pro",
    name: PLAN_BY_KEY.pro.name,
    tagline: PLAN_BY_KEY.pro.tagline,
    price: `$${PLAN_BY_KEY.pro.priceUSD}`,
    originalPrice: "$97",
    savings: "Save $30",
    billing: PLAN_BY_KEY.pro.billing,
    billingNote: "One-time payment · lifetime access",
    aiCredits: `${PLAN_BY_KEY.pro.credits} AI credits`,
    exportQuality: "4K Ultra HD",
    commercialUsage: "Commercial license",
    priority: "Priority",
    support: "Priority email support",
    limits: [`${PLAN_BY_KEY.pro.credits} AI credits`, "Up to 4K exports", "1 user seat"],
    features: [
  ...
  {
    id: "agency",
    name: PLAN_BY_KEY.agency.name,
    tagline: PLAN_BY_KEY.agency.tagline,
    price: `$${PLAN_BY_KEY.agency.priceUSD}`,
    originalPrice: "$297",
    savings: "Save $100",
    billing: PLAN_BY_KEY.agency.billing,
    billingNote: "One-time payment · lifetime access",
    aiCredits: `${PLAN_BY_KEY.agency.credits.toLocaleString()} AI credits`,
    exportQuality: "4K Ultra HD",
    commercialUsage: "Commercial license + white-label",
    priority: "Highest",
    support: "Dedicated account manager",
    limits: [`${PLAN_BY_KEY.agency.credits.toLocaleString()} AI credits`, "Up to 4K exports", "Up to 5 user seats"],
    features: [
      "Everything in Pro",
      "API access",
  ...
  {
    id: "vip",
    name: PLAN_BY_KEY.vip.name,
    tagline: PLAN_BY_KEY.vip.tagline,
    price: `$${PLAN_BY_KEY.vip.priceUSD}`,
    billing: PLAN_BY_KEY.vip.billing,
    billingNote: "Billed monthly · cancel anytime",
    aiCredits: `${PLAN_BY_KEY.vip.credits.toLocaleString()} AI credits / mo`,
    exportQuality: "4K Ultra HD",
    commercialUsage: "Commercial license",
    priority: "Highest (VIP queue)",
    support: "1:1 onboarding + priority",
    limits: [`${PLAN_BY_KEY.vip.credits.toLocaleString()} monthly credits`, "Up to 4K exports", "Priority rendering"],
    features: [
